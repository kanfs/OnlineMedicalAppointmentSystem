    ...
    <div class="app-container">
        ...
        <div class="tools-div">
            <el-button
                ...
                size="mini"
                @click="add()"
                :disabled="$hasBP('bnt.menu.add') === false"
                >添 加</el-button>
        </div>
        <el-table
            :data="menuList"
            ...
            >
                <template slot-scope="scope">
                    ...
                    <el-button
                        ...
                        :disabled="$hasBP('bnt.menu.update') === false"
                        title="修改"
                    />
                    <el-button
                        type="danger"
                        ...
                        title="删除"
                        :disabled="scope.row.children.length > 0 || $hasBP('bnt.menu.remove') === false"
                    />
                </template>
            </el-table-column>
        </el-table>
        ...
        >
            ...
            >
                <el-form-item label="上级部门" v-if="menu.id === ''">
                ...
                <el-form-item prop="component" v-if="menu.type !== 0">
                    <span slot="label">
                        <el-tooltip
                            content="访问的组件路径，如：`system/admin/index`，默认在`views`目录下"
                            placement="top"
                        >
                            <i class="el-icon-question"></i>
                        </el-tooltip>
                ...
                <el-form-item v-if="menu.type === 2">
                    ...
                    <span slot="label">
                        <el-tooltip
                            content="控制器中定义的权限字符，如：@PreAuthorize(hasAuthority('bnt.role.list'))"
                            placement="top"
                        >
                            <i class="el-icon-question"></i>
                        </el-tooltip>
...
export default {
    ...
    methods: {
        ...
        //添加
        save() {
            api.save(this.menu).then(response => {
