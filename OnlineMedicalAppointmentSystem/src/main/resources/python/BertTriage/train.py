...
config_path='.//bert_weight_files/roberta/bert_config_rbt3.json'
checkpoint_path='./bert_weight_files/roberta/bert_model.ckpt'
dict_path = './bert_weight_files/roberta/vocab.txt'
...
if __name__ == '__main__':
    ...
    target_names = [line.strip().split("\t")[1] for line in open('./data/label.txt','r',encoding='utf8')]
